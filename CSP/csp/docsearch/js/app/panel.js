$(function(){
	$('.panel').tabSlideOut({						//Класс панели
		...
		pathToTabImage: 'style/images/logo-telegram.png',			//Путь к изображению кнопки
		imageHeight: '60px',						//Высота кнопки
		imageWidth: '60px',							//Ширина кнопки
		...
		speed: 390,									//Скорость анимации
		action: 'click',							//Метод показа click - выдвигается по клику на кнопку, hover - выдвигается при наведении курсора
		topPos: '15%',								//Отступ сверху
